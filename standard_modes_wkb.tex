...
\beq
\label{strech}
\sL \defn \frac{\dd}{\dd z}\frac{f_0^2}{N^2}\frac{\dd}{\dd z} \com
\eeq
...
\beq
\label{N_avg}
\overline{N} =\frac{1}{h} \int_{-h}^0N(\xi)\dd \xi\per
\eeq
...
With $N = \text{const.}$  the modes are the simple sinusoids. That result is recovered as a special case of the WKB solution
\beq
